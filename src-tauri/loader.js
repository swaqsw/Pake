...
(function(){
    ...
    window.GM_xmlhttpRequest = function(details) {
        ...
        if (details.headers) {
            Object.keys(details.headers).forEach(function(h) { xhr.setRequestHeader(h, details.headers[h]); });
        }
        xhr.onload = function() {
            var resp = {
        ...
        xhr.onerror = function(e) { if (details.onerror) details.onerror(e); };
...
(function() {
    ...
    var scriptListUrl = 'https://raw.githubusercontent.com/你的用户名/你的仓库/main/scripts.txt';
    ...
    listXhr.onload = function() {
        if (listXhr.status >= 200 && listXhr.status < 400) {
            var urls = listXhr.responseText.split('\n')
                .map(function(s) { return s.trim(); })
                .filter(function(s) { return s && s.indexOf('http') === 0; });
            var i = 0;
            function next() {
                if (i < urls.length) {
